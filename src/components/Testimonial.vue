                ...
                <swiper-slide>
                    ...
                    <div class="flex flex-col items-center pb-10 ">
                        ...
                        <figure class="max-w-screen-md mx-auto text-center">
                            ...
                            <blockquote>
                                <p class="text-2xl italic font-medium text-gray-900 dark:text-white">{{ testimonial.text }}</p>
                            </blockquote>
                            <figcaption class="flex items-center justify-center mt-6 space-x-3 rtl:space-x-reverse">
                                ...
                                <div
                                    ...
                                    <cite class="pe-3 font-medium text-gray-900 dark:text-white">{{ testimonial.name }}</cite>
                                    <cite class="ps-3 text-sm text-gray-500 dark:text-gray-400">{{ testimonial.position }}</cite>
                                </div>
                            </figcaption>
                        </figure>
